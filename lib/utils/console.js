    ...
    SlimConsole.prototype._log = function (type) {
        ...
        if (typeof window !== 'undefined') {
            ...
            if (text) {
                ...
                console.log.apply(console, __spreadArray(["%c ".concat(title), "background:".concat(color, ";border:1px solid ").concat(color, "; padding: 1px; border-radius: 2px 0 0 2px; color: #fff;"), "border:1px solid ".concat(color, "; padding: 1px; border-radius: 0 2px 2px 0; color: ").concat(color, ";"), 'background:transparent'], arr, false));
            }
        }
